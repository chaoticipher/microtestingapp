...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'd6ac19d9-e49e-4048-b4d0-ef0d3225c791' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('0c7483cc-995d-4dcc-94ca-5271b45ec3f6');
      cy.get(`[data-cy="name"]`).should('have.value', '0c7483cc-995d-4dcc-94ca-5271b45ec3f6');
